...
export const LandingHero2 = () => {
  ...
  return (
    <div className="flex justify-center pt-14">
      ...
      <div className="w-1/2">
        <Spline className='w-full flex scale-[.25] sm:scale-[.35] lg:scale-[0.7] items-center justify-center md:justify-start' scene='https://prod.spline.design/zDDWcDP2YcgQcRdF/scene.splinecode' />
      </div>
    </div>
  );
};
